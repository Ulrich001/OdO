class Explorer {
    ...
    // Explorer öffnen oder schließen
    toggle() {
        if (this.enabled) {
            this.close()
        } else {
    ...
    // Explorer einblenden und Dateien laden
    open() {
        this.enabled = true;
    ...
    // Lädt den Inhalt eines Ordners in die Dateiliste
    ...
    // Erstellt ein div-Element für eine Datei oder einen Ordner und fügt es zur Liste hinzu
    addEntry(entry) {
        // div erstellen
